 ...
 * In order to <i>batch</i> setting values there is a {@link #batch()} method. See {@link BatchWork}
 *
 * <h3>참고</h3>
 * <code>remote process 일 경우는 프리퍼런스를 사용하지 말고 DB를 사용하자</code>
 *
...
public class SimplePrefs {
    ...
    /**
     * @return {@link BatchWork} implementation to batch setting values
     */
    public BatchWork batch() {
        return new BatchWorkImpl(this);
    }
